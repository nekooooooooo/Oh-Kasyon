...
import kotlinx.android.synthetic.main.activity_sign_up.button_sign_up
...
import kotlinx.android.synthetic.main.activity_sign_up.text_alert
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_sign_up.setOnClickListener {
            ...
            if (suffix.isEmpty()) {
                edit_text_contact.error = "Phone Number Required!"
                edit_text_contact.requestFocus()
                return@setOnClickListener
            }
                        ...
                        user?.updateProfile(updates)
                            ?.addOnCompleteListener { task ->
                                ...
                                if(task.isSuccessful) {
                                    ...
                                    showAlertDialog("success", "Registered! Returning to Login Screen", 3)
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                ...
                if(task.isSuccessful){
                    ...
                    val db = FirebaseFirestore.getInstance()
                    val dateCreated = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'").format(Calendar.getInstance().time)
